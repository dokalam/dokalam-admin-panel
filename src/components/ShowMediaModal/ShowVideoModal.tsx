...
const ShowVideoModal = forwardRef((_, ref) => {
        ...
        >
          ...
          <div className="flex justify-center items-center h-[100dvh] fixed inset-0 z-10 w-screen">
            <div className="absolute top-5 right-5 flex items-center gap-4 sm:gap-4">
              <div className="text-2xl z-[6000] rounded-md text-[#eee] bg-[#00000070] p-1 pointer-events-none">
            ...
            >
              <Dialog.Panel className="h-full max-h-[80dvh] relative w-full sm:max-w-lg 2xl:max-w-2xl flex justify-center items-center">
                {isOpen && (
                  <video src={src} controls className="video h-full" autoPlay={autoPlay} />
                )}
              </Dialog.Panel>
            </Transition.Child>
          </div>
...
ShowVideoModal.displayName = "ShowVideoModal";
export default memo(ShowVideoModal);
